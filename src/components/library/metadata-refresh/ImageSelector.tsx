...
export function ImageSelector({
  ...
  const tabs = [
    { id: 'posters' as ImageTab, label: 'Posters', count: posters.length, icon: '🖼️' },
    { id: 'backgrounds' as ImageTab, label: 'Backgrounds', count: backgrounds.length, icon: '🌄' },
    { id: 'logos' as ImageTab, label: 'Logos', count: logos.length, icon: '✨' },
    { id: 'banners' as ImageTab, label: 'Banners', count: banners.length, icon: '📐' },
  ];

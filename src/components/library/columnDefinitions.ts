...
export const movieColumns: ColumnDefinition[] = [
  ...
  { id: 'collection', label: 'Movie set', visible: false, sortable: true, width: 150 },
  // Rating group
  ...
  { id: 'imdbRating', label: 'Rating - IMDb', visible: false, sortable: true, width: 100 },
  { id: 'rottenTomatoesRating', label: 'Rating - Rotten Tomatoes', visible: false, sortable: true, width: 100 },
  { id: 'metascore', label: 'Rating - Metascore', visible: false, sortable: true, width: 100 },
  { id: 'tmdbRating', label: 'Rating - TMDB', visible: false, sortable: true, width: 100 },
  { id: 'top250', label: 'Top 250', visible: false, sortable: true, width: 80 },
  { id: 'votes', label: 'Votes', visible: false, sortable: true, width: 80 },
  ...
  { id: 'fileCreationDate', label: 'File creation date', visible: false, sortable: true, width: 120 },
  // Runtime group
  { id: 'duration', label: 'Runtime [min]', visible: true, sortable: true, width: 120 },
  { id: 'durationHHMM', label: 'Runtime [hh:mm]', visible: false, sortable: true, width: 120 },
  // Format group
  { id: 'aspectRatio', label: 'Aspect ratio', visible: false, sortable: false, width: 100 },
  { id: 'secondAspectRatio', label: '2nd aspect ratio', visible: false, sortable: false, width: 100 },
  { id: 'hdr', label: 'HDR', visible: false, sortable: false, width: 80 },
  { id: 'hdrFormat', label: 'HDR format', visible: false, sortable: false, width: 120 },
  // Video codec group
  ...
  { id: 'audioStreamCount', label: 'Audio stream count', visible: false, sortable: false, width: 100 },
  { id: 'videoFileSize', label: 'Video file size', visible: false, sortable: true, width: 100 },
  // Other
  { id: 'edition', label: 'Edition', visible: false, sortable: true, width: 100 },
  { id: 'source', label: 'Source', visible: false, sortable: true, width: 100 },
  { id: 'container', label: 'Format', visible: false, sortable: false, width: 80 },
  { id: 'size', label: 'Total file size', visible: false, sortable: true, width: 100 },
  { id: 'videoResolution', label: 'Resolution', visible: false, sortable: false, width: 100 },
  { id: 'threeD', label: '3D', visible: false, sortable: false, width: 60 },
  // Metadata
  { id: 'hasImages', label: 'Images', visible: false, sortable: false, width: 80 },
  { id: 'trailer', label: 'Trailer', visible: false, sortable: false, width: 80 },
  { id: 'subtitles', label: 'Subtitles', visible: false, sortable: false, width: 100 },
...
export const tvShowColumns: ColumnDefinition[] = [
  ...
  { id: 'seasonCount', label: 'Season count', visible: true, sortable: true, width: 100 },
  { id: 'leafCount', label: 'Episode count', visible: true, sortable: true, width: 100 },
  { id: 'missingEpisodeCount', label: 'Missing episode count', visible: false, sortable: true, width: 100 },
  { id: 'status', label: 'Status', visible: false, sortable: true, width: 100 },
  // Path/Filename
  { id: 'path', label: 'Path', visible: false, sortable: false },
  { id: 'filename', label: 'Filename', visible: false, sortable: false },
  // Rating group
  ...
  { id: 'contentRating', label: 'Certification', visible: false, sortable: true, width: 100 },
  // Date group
  { id: 'addedAt', label: 'Date added (TV show)', visible: false, sortable: true, width: 120 },
  { id: 'episodeAddedAt', label: 'Date added (Episode)', visible: false, sortable: true, width: 120 },
  { id: 'fileCreationDate', label: 'File creation date', visible: false, sortable: true, width: 120 },
  // Runtime group
  { id: 'duration', label: 'Runtime [min]', visible: false, sortable: true, width: 120 },
  { id: 'durationHHMM', label: 'Runtime [hh:mm]', visible: false, sortable: true, width: 120 },
  // Format group
  { id: 'container', label: 'Format', visible: false, sortable: false, width: 80 },
  { id: 'hdr', label: 'HDR', visible: false, sortable: false, width: 80 },
  ...
  { id: 'videoCodec', label: 'Video codec', visible: false, sortable: false, width: 120 },
  { id: 'bitrate', label: 'Video bitrate', visible: false, sortable: false, width: 120 },
  { id: 'audioCodec', label: 'Audio', visible: false, sortable: false, width: 120 },
  { id: 'audioStreamCount', label: 'Audio stream count', visible: false, sortable: false, width: 100 },
  { id: 'videoFileSize', label: 'Video file size', visible: false, sortable: true, width: 100 },
  { id: 'size', label: 'Total file size', visible: false, sortable: true, width: 100 },
  { id: 'aspectRatio', label: 'Aspect ratio', visible: false, sortable: false, width: 100 },
  { id: 'source', label: 'Source', visible: false, sortable: true, width: 100 },
  // Metadata
  { id: 'newEpisodes', label: 'New episodes', visible: false, sortable: false, width: 100 },
  { id: 'hasImages', label: 'Metadata', visible: false, sortable: false, width: 80 },
  // Images
  { id: 'trailer', label: 'Trailer', visible: false, sortable: false, width: 80 },
  { id: 'subtitles', label: 'Subtitles', visible: false, sortable: false, width: 100 },
  { id: 'viewCount', label: 'Watched', visible: false, sortable: true, width: 80 },
  { id: 'musicTheme', label: 'Music Theme', visible: false, sortable: false, width: 100 },
  { id: 'note', label: 'Note', visible: false, sortable: false },
];
